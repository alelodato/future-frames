      ...
      <div className={styles.overlay}>
        <div className={`container ${styles.content}`}>
          ...
          <div className={styles.ctas}>
            <a href="#portfolio" className={`${styles.btn} ${styles.primary}`} data-aos="fade-up" data-aos-delay="3000">
              SCOPRI I NOSTRI LAVORI
            </a>
            <a href="#contatti" className={`${styles.btn} ${styles.outline}`} data-aos="fade-up" data-aos-delay="3000">
